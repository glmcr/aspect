  ...
  namespace Particle
  {
	...
	void get_strain_data_update(struct strain_data&,
	  ...
	  static constexpr const char* PARTIALLY_MELTED_SSZ_ASTH_NID= "pmeltedSszAsth";
          ...
          static constexpr const char* CONT_LOWER_CRUST_NID= "contLowCrust";
	...
	mutable MaterialModel::MaterialModelInputs<dim> material_inputs;
      ...
      sszMtcPT3(PTStateMarker::PASCALS_2_MEGA_PASCALS*4.7e9, 1655.0); // --- 47Kb, 1382C
      ...
      template <int dim>
      const PTStateMarker LUSIComposition<dim>::
      sszMtcPT4(PTStateMarker::PASCALS_2_MEGA_PASCALS*LUSIComposition<dim>::MOHO_PRESSURE_PASCALS, 1388.0);  //  1115C
