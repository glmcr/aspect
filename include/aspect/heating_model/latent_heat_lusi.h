...
#ifndef _aspect_heating_model_latent_heat_lusi_h
#define _aspect_heating_model_latent_heat_lusi_h
...
namespace aspect
{
  namespace HeatingModel
  {
     ...
     */
    template <int dim>
    class LatentHeatLusi : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
